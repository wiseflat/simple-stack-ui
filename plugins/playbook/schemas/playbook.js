NEWSCHEMA('Playbooks', function(schema) {
	...
	schema.action('query', {
		...
		action: function($) {
			DATA.list('nosql/playbooks').autoquery($.query, 'id:string,name:string,cron:Boolean,dtcreated:string,dtupdated:string,summary:string', 'name_asc', 100).callback(function(err, response){
